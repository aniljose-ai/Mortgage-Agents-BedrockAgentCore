...
There is also a `.bedrock_agentcore.yaml` file output in the `mortgageAgents` directory. This file contains a minimal definition with your agent name when it is created. After deploying the project, when running
